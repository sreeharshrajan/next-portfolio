          ...
          <div className="max-w-2xl text-center mx-auto">
            ...
            <div className="mt-5 max-w-2xl">
              <motion.h1
                ...
                whileInView={`show`}
                initial={`hidden`}
                className="block leading-normal font-semibold text-gray-800 text-4xl md:text-6xl lg:text-8xl dark:text-gray-200"
              >
                Full Stack
                <br />
                Developer
            ...
            >
              <p className="leading-6 text-sm md:text-md lg:text-lg text-gray-600 dark:text-gray-400">
            ...
            <div className="mt-8 gap-3 flex justify-center">
              <motion.a
                ...
                whileInView={`show`}
                initial={`hidden`}
                className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-indigo-500 text-white hover:bg-indigo-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
